...
def _console_commands() -> tuple[ConsoleCommand, ...]:
    from src.localhost.commands.core import (
    ...
    from src.localhost.commands.emit import _handle_event_command
    from src.localhost.commands.invoke import _handle_invoke_command
    from src.localhost.commands.memtest import _handle_memtest_command
    from src.localhost.commands.say import _handle_say_command
    from src.localhost.commands.self_cli import (
